-- ============================================================
-- BARTER TRADE NAMIBIA - COMPLETE DATABASE SETUP
-- ============================================================
-- This is the ONLY script you need to run.
-- It creates ALL tables and is safe to run multiple times.
-- Uses IF NOT EXISTS to avoid duplicate errors.
-- 
...
-- ==========================================
-- 27. ID VERIFICATION REQUESTS TABLE
-- ==========================================
...
-- ==========================================
-- 28. ACTIVITY LOG TABLE (Comprehensive)
-- ==========================================
...
-- ==========================================
-- 31. TOP-UP REQUESTS TABLE (Mobile Money)
-- ==========================================
...
-- ==========================================
INSERT IGNORE INTO vouchers (id, code, amount, status, created_by, expires_at) VALUES
(UUID(), 'WELCOME50', 50.00, 'available', 'admin-001', DATE_ADD(NOW(), INTERVAL 90 DAY)),
(UUID(), 'TRADE100', 100.00, 'available', 'admin-001', DATE_ADD(NOW(), INTERVAL 90 DAY)),
(UUID(), 'BARTER200', 200.00, 'available', 'admin-001', DATE_ADD(NOW(), INTERVAL 90 DAY)),
(UUID(), 'NEWUSER25', 25.00, 'available', 'admin-001', DATE_ADD(NOW(), INTERVAL 90 DAY));
